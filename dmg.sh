...
codesign --force --deep --sign - "dist/DuckAgent.app"


echo "[*] Creating DMG layout..."
mkdir dmg_staging
cp -R "dist/DuckAgent.app" dmg_staging/
ln -s /Applications dmg_staging/Applications


echo "[*] Finalizing DMG..."
hdiutil create -volname "DuckAgent" -srcfolder dmg_staging -ov -format UDZO "DuckAgent Installer.dmg"


rm -f icon.icns

echo "[+] Done! Duck Local Model Installer.dmg is ready."
